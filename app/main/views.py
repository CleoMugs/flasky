...
def edit_profile_admin(id):
	...
	if form.validate_on_submit():
		...
		user.confirmed = roleform.confirmed.data
		user.role = form.role.data
		user.namelocation = form.namelocation.data
		user.location = form.location.data
		user.about_me = form.about_me.dataabout_me
...
def post(id):
	...
	if form.validate_on_submit():
		...
		flash('Your comment has been publisged')
